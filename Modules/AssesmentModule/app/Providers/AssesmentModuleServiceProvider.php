...
use Modules\AssesmentModule\Observers\QuizObserver;
use Nwidart\Modules\Traits\PathNamespace;
use RecursiveDirectoryIterator;
use RecursiveIteratorIterator;

class AssesmentModuleServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'AssesmentModule';

    protected string $nameLower = 'assesmentmodule';
